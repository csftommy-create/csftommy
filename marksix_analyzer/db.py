...
CREATE TABLE IF NOT EXISTS draws (
    ...
    jackpot     INTEGER,
    CHECK (n1 BETWEEN 1 AND 49), CHECK (n2 BETWEEN 1 AND 49),
    CHECK (n3 BETWEEN 1 AND 49), CHECK (n4 BETWEEN 1 AND 49),
    CHECK (n5 BETWEEN 1 AND 49), CHECK (n6 BETWEEN 1 AND 49),
    CHECK (extra BETWEEN 1 AND 49)
);
